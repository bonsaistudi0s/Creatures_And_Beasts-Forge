...
import com.cgessinger.creaturesandbeasts.util.IRunningEntity;
...
public abstract class AbstractSporelingEntity extends PathfinderMob implements IAnimatable, ITimedAttackEntity, IRunningEntity {
    ...
    public enum SporelingType {
        OVERWORLD_BROWN(createLocation("geo/overworld_brown_sporeling.geo.json"),
                createLocation("textures/model/entity/sporeling_brown_overworld.png")),
        OVERWORLD_RED(createLocation("geo/overworld_red_sporeling.geo.json"),
