...
public class CNBEntityTypes {
    ...
    /* CREATURES */
    public static final RegistryObject<EntityType<GrebeEntity>> LITTLE_GREBE = ENTITY_TYPES.register("little_grebe", () -> EntityType.Builder.of(GrebeEntity::new, MobCategory.CREATURE).sized(0.5f, 0.6f).build(new ResourceLocation(CreaturesAndBeasts.MOD_ID, "little_grebe").toString()));
    ...
    public static final RegistryObject<EntityType<FriendlySporelingEntity>> FRIENDLY_SPORELING = ENTITY_TYPES.register("friendly_sporeling", () -> EntityType.Builder.of(FriendlySporelingEntity::new, MobCategory.CREATURE).sized(0.6f, 0.85f).build(new ResourceLocation(CreaturesAndBeasts.MOD_ID, "friendly_sporeling").toString()));

    /* MONSTERS */
    public static final RegistryObject<EntityType<HostileSporelingEntity>> HOSTILE_SPORELING = ENTITY_TYPES.register("hostile_sporeling", () -> EntityType.Builder.of(HostileSporelingEntity::new, MobCategory.MONSTER).sized(0.6f, 0.85f).fireImmune().build(new ResourceLocation(CreaturesAndBeasts.MOD_ID, "hostile_sporeling").toString()));

    public static final RegistryObject<EntityType<NeutralSporelingEntity>> NEUTRAL_SPORELING = ENTITY_TYPES.register("neutral_sporeling", () -> EntityType.Builder.of(NeutralSporelingEntity::new, MobCategory.MONSTER).sized(0.6f, 0.85f).fireImmune().build(new ResourceLocation(CreaturesAndBeasts.MOD_ID, "neutral_sporeling").toString()));
