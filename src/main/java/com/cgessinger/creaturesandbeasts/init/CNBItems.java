...
public class CNBItems {
    ...
    // Sporelings
    public static RegistryObject<ModSpawnEggItem> SPORELING_OVERWORLD_BROWN_EGG = ITEMS.register("sporeling_overworld_brown_egg", () -> new ModSpawnEggItem(CNBEntityTypes.SPORELING, 0xF2DDD3, 0xCD9777, new Item.Properties().tab(CreaturesAndBeasts.TAB)).spawnsVariant(0));
    public static RegistryObject<ModSpawnEggItem> SPORELING_OVERWORLD_RED_EGG = ITEMS.register("sporeling_overworld_red_egg", () -> new ModSpawnEggItem(CNBEntityTypes.SPORELING, 0xCB1A1A, 0xF2DDD3, new Item.Properties().tab(CreaturesAndBeasts.TAB)).spawnsVariant(1));
    public static RegistryObject<ModSpawnEggItem> SPORELING_NETHER_BROWN_EGG = ITEMS.register("sporeling_nether_brown_egg", () -> new ModSpawnEggItem(CNBEntityTypes.SPORELING, 0xC68F70, 0x7C533F, new Item.Properties().tab(CreaturesAndBeasts.TAB)).spawnsVariant(2));
    public static RegistryObject<ModSpawnEggItem> SPORELING_NETHER_RED_EGG = ITEMS.register("sporeling_nether_red_egg", () -> new ModSpawnEggItem(CNBEntityTypes.SPORELING, 0xCC9575, 0xB31A1A, new Item.Properties().tab(CreaturesAndBeasts.TAB)).spawnsVariant(3));
    public static RegistryObject<ModSpawnEggItem> SPORELING_WARPED_FUNGI_EGG = ITEMS.register("sporeling_warped_fungi_egg", () -> new ModSpawnEggItem(CNBEntityTypes.SPORELING, 0x139A88, 0xD66818, new Item.Properties().tab(CreaturesAndBeasts.TAB)).spawnsVariant(4));
    public static RegistryObject<ModSpawnEggItem> SPORELING_CRIMSON_FUNGUS_EGG = ITEMS.register("sporeling_crimson_fungus_egg", () -> new ModSpawnEggItem(CNBEntityTypes.SPORELING, 0x9E1104, 0xF88539, new Item.Properties().tab(CreaturesAndBeasts.TAB)).spawnsVariant(5));
}
