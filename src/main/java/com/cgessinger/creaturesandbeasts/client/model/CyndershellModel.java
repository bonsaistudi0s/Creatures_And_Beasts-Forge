...
public class CyndershellModel<L extends AnimalEntity> extends EntityModel<CyndershellEntity>
{
	...
	public CyndershellModel () {
		...
		bone.setTextureOffset(1, 20).addBox(-7.0F, -29.0F, -7.0F, 14.0F, 3.0F, 14.0F, 0.0F, false);
		bone.setTextureOffset(0, 155).addBox(-10.0F, -26.0F, -12.0F, 20.0F, 15.0F, 23.0F, 0.0F, false);
		bone.setTextureOffset(0, 65).addBox(-11.0F, -14.0F, -13.0F, 22.0F, 4.0F, 25.0F, 0.0F, false);
		bone.setTextureOffset(35, 49).addBox(-6.0F, -15.0F, -14.0F, 12.0F, 6.0F, 5.0F, 0.0F, false);

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone.addChild(bone2);
		bone2.setTextureOffset(68, 229).addBox(-8.0F, -11.0F, -11.0F, 16.0F, 6.0F, 21.0F, 0.0F, false);
		...
		Jaw.setTextureOffset(218, 240).addBox(-3.5F, -2.0F, -12.5F, 7.0F, 4.0F, 12.0F, 0.0F, false);

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(0.0F, 0.0F, 0.0F);
		Head.addChild(bone4);
		setRotationAngle(bone4, 0.0873F, 0.0F, 0.0F);
		bone4.setTextureOffset(248, 193).addBox(-1.0F, -6.0F, -11.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		bone4.setTextureOffset(244, 203).addBox(-1.5F, -4.0F, -11.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		bone4.setTextureOffset(220, 209).addBox(-3.0F, -3.0F, -12.0F, 6.0F, 4.0F, 12.0F, 0.0F, false);
		...
		bone3.setTextureOffset(27, 243).addBox(-4.0F, -3.0F, -1.0F, 8.0F, 5.0F, 8.0F, 0.0F, false);
		bone3.setTextureOffset(0, 248).addBox(-2.0F, -3.0F, 7.0F, 4.0F, 2.0F, 6.0F, 0.0F, false);

		FR = new ModelRenderer(this);
		FR.setRotationPoint(-7.0F, -8.0F, -6.5F);
		bone.addChild(FR);
		FR.setTextureOffset(236, 125).addBox(-2.0F, 0.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0.0F, false);

		BR = new ModelRenderer(this);
		BR.setRotationPoint(-8.0F, -8.0F, 5.5F);
		bone.addChild(BR);
		BR.setTextureOffset(236, 125).addBox(-1.0F, 0.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0.0F, false);

		BL = new ModelRenderer(this);
		BL.setRotationPoint(7.0F, -8.0F, 5.5F);
		bone.addChild(BL);
		BL.setTextureOffset(236, 125).addBox(-3.0F, 0.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0.0F, false);

		FL = new ModelRenderer(this);
		FL.setRotationPoint(9.0F, -8.0F, -6.5F);
		bone.addChild(FL);
		FL.setTextureOffset(236, 125).addBox(-5.0F, 0.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0.0F, false);
	}
